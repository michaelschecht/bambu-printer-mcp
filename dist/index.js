...
function resolveFilamentProfileDir() {
...
const MCP_LOG_PATH = process.env.BAMBU_MCP_LOG ||
...
function installStdioSurvival() {
    ...
    process.on("beforeExit", (code) => mcpLog(`beforeExit (code ${code}) - the event loop emptied`));
